...
public class ExpenseController {
    ...
    public Wrapper<Expense> deleteExpense(@ApiParam(value = "Идентификатор мероприятия")@PathVariable long event_id, @ApiParam(value = "Идентификатор предмета расходов")@PathVariable long expense_id) {
        Event event = eventRepo.findEventById(event_id);
        Expense expense = expenseRepo.findExpenseByIdAndEvent(expense_id, event);
